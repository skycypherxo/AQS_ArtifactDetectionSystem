...
class RealTimeAQSAnalyzer:
    ...
    def __init__(self, 
        ...
        self.aqs_metric = AQSMetric(temporal_window=30)
        ...
        for i in range(len(sequences)):
            ...
            result = {
                ...
                'aqs_analysis': {
                    ...
                    'artifact_severity': float(aqs_analysis['artifact_severity'].item() if aqs_analysis['artifact_severity'].dim() == 0 else aqs_analysis['artifact_severity'][0]),
